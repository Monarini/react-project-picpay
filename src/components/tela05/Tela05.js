    ...
    return (
        <div id="tela-05" className='grid background5'>
            <div className='div800 container-05'>
                <div className='caixa'>
                    <span className='textoBranco text-align-center container-text p-20' >Mas, no atual cenário que vivemos, com sistemas complexos, distribuídos em microsserviços, não é mais a técnica ideal para entender e resolver problemas críticos em sistemas de Engenharia de Software.</span>
                </div>
                <div className="caixa">
                    <img className='imagemTela5 ' src={caixa_imagem} alt="Caixa de texto com imagem"/>
                </div>
                <div className="caixa">
                <MyModal name="SAIBA MAIS" content="Apesar de ser considerado um dos sinais para praticar a Observabilidade, as métricas são muito limitantes para servir como um bloco de construção fundamental da Observabilidade. Por esse motivo, você não deve acreditar que métricas são um dos pilares da Observabilidade (assim como logs também não são e você vai saber o motivo mais adiante)." />
                </div>
