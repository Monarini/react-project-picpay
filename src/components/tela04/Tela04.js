    ...
    return (
        <div id="tela-04" className='grid background4'>
            ...
            <div className="container-04">
                    ...
                    <span className='textoBranco'>Por muitos anos, as equipes de TI mediam a disponibilidade e performance de suas aplicações através da coleta de métricas. O monitoramento gira em torno de alertas e interrupções.<br/><br/><br/>
                                                  Depende de falhas conhecidas do passado de acordo com limites previsíveis que foram julgados como anomalias.<br/><br/><br/>
                                                  ...
                                                  <div>
            <Link to="tela-05" smooth={true} duration={500} ><button className="btnSeta" type="button">
